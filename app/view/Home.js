  ...
  layout:{
        ...
        items: [
		{
      ...
      
            {
                ...
                html: [
                       '<div class="myHomeContainer" style="width: 1000px; margin-left: auto; margin-right: auto;"><iframe width="100%" height="800px" frameBorder="0" style="-webkit-transform:scale(0.6);	 -moz-transform: scale(0.6); " class="noScrolling" scrolling="no" seamless="seamless" src="http://ladybugdesign.co.uk/slidingpuzzle/index.html"></iframe></div>'
